...
class BatBoyHelperTest < ActionView::TestCase
  ...
  def setup
    ...
    @n01_batboy_for_angels_about_to_bat_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n02_batboy_for_trout_in_hole1_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n03_batboy_for_trout_in_hole2_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n04_batboy_for_trout_in_hole3_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n05_batboy_for_trout_at_bat1_ft = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n06_batboy_for_trout_at_bat_done_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n07_batboy_for_trout_batting_2_ft = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n08_batboy_for_trout_on_deck_1_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n09_batboy_for_trout_on_deck_2_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n10_batboy_for_trout_on_deck_3_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n11_batboy_for_trout_on_deck_fpt_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n12_batboy_for_trout_just_struck_out_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n13_batboy_for_trout_on_deck_bottom_of_inning_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n14_batboy_for_trout_in_hole4_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n15_batboy_for_trout_on_deck_4_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n16_batboy_for_trout_on_deck_5_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n17_batboy_for_trout_on_deck_inning_not_over_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n18_batboy_for_trout_batting_3_ft = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n19_batboy_for_trout_on_deck_6_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n20_batboy_for_trout_on_deck_7_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n21_batboy_for_player_hit_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n22_batboy_for_home_game_over_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n23_batboy_for_three_lineup_changes_ff = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
  ...
  test "should use stubbed version of game JSON" do
    file = File.read('test/helpers/bat_boy_helper_test_api_returns/home_game_over.json')
    home_game_over = JSON.parse(file, :symbolize_names => true)
    assert_equal home_game_over, @n22_batboy_for_home_game_over_ff.inspect
  end

  # ====================================================================

  test "game_going_on? ~~ returns true if the game is still on" do
    assert_equal true, @n07_batboy_for_trout_batting_2_ft.game_going_on?
    # assert_equal true, @batboy_for_trout_on_deck_1.game_going_on?
  end

  test "game_going_on? ~~ returns false if the game is over" do
    assert_equal false, @n22_batboy_for_home_game_over_ff.game_going_on?
  end

# ====================================================================

  test "trout_on_deck? ~~ returns false if game is over" do
    assert_equal false, @n22_batboy_for_home_game_over_ff.trout_on_deck?
  end
  ...
  test "trout_at_bat? ~~ should return false if game is over" do
    assert_equal false, @n22_batboy_for_home_game_over_ff.trout_at_bat?
  end
  ...
  test "all_lineup_events ~~ lists all Angels lineup events" do
    assert_equal 4, @n23_batboy_for_three_lineup_changes_ff.all_lineup_events.length
  end

# ====================================================================

  test "players_lineup_number ~~ knows someone's lineup number when there have been no changes since game beginning" do
    assert_equal 2, @n22_batboy_for_home_game_over_ff.players_lineup_number(TROUT_ID)
  end

  test "players_lineup_number ~~ knows someone's lineup number after changes" do
    assert_equal 6, @n22_batboy_for_home_game_over_ff.players_lineup_number("68298270-9c8e-4139-a8f8-632151fb7077")
    assert_equal 8, @n22_batboy_for_home_game_over_ff.players_lineup_number("9de4255a-b1d5-455d-bde9-0ae9633e5495")
  end

# ====================================================================

  test "angels_home_game? ~~ returns true if venue is Angel's stadium" do
    assert_equal true, @n22_batboy_for_home_game_over_ff.angels_home_game?
  end
...
# ====================================================================
  ...
  test "player_at_bat ~~ should return nil if game is over" do
    assert_nil @n22_batboy_for_home_game_over_ff.player_at_bat
  end
