...
class BatBoyHelperTest < ActionView::TestCase
  ...
  def setup
    ...
    @n10_trout_on_deck_2_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n13_trout_on_deck_inning_not_over_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n26_trout_on_deck_bottom_of_inning_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")

    file = File.read('test/helpers/bat_boy_helper_test_api_returns/Home_Hitting_TroutOut_FPNT_FF.json')
    trout_on_deck_bottom_of_inning = JSON.parse(file, :symbolize_names => true)
    BatBoy.any_instance.stubs(:get_game_info).returns(trout_on_deck_bottom_of_inning)
    @n27_trout_on_deck_bottom_of_inning_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
    ...
    @n28_trout_on_deck_9_tf = BatBoy.new("d7a9a7c5-958b-453b-8789-5bc9469a8e7c")
  ...
  test "game_going_on? ~~ returns true if the game is still on" do
    ...
    assert_equal true, @n10_trout_on_deck_2_tf.game_going_on?
    assert_equal true, @n11_trout_on_deck_3_tf.game_going_on?
    assert_equal true, @n12_player_hit_ff.game_going_on?
    assert_equal true, @n13_trout_on_deck_inning_not_over_tf.game_going_on?
    ...
    assert_equal true, @n26_trout_on_deck_bottom_of_inning_tf.game_going_on?
    assert_equal true, @n27_trout_on_deck_bottom_of_inning_tf.game_going_on?
    assert_equal true, @n28_trout_on_deck_9_tf.game_going_on?
  end
...
# ====================================================================
  ...
  test "trout_on_deck? ~~ returns true if Trout is on deck" do
    ...
    assert_equal true, @n10_trout_on_deck_2_tf.trout_on_deck?
    assert_equal true, @n11_trout_on_deck_3_tf.trout_on_deck?
    assert_equal true, @n13_trout_on_deck_inning_not_over_tf.trout_on_deck?
    ...
    assert_equal true, @n26_trout_on_deck_bottom_of_inning_tf.trout_on_deck?
    assert_equal true, @n27_trout_on_deck_bottom_of_inning_tf.trout_on_deck?
    assert_equal true, @n28_trout_on_deck_9_tf.trout_on_deck?
  end
  ...
  test "trout_at_bat? ~~ should return false if Trout is on deck" do
    ...
    assert_equal false, @n10_trout_on_deck_2_tf.trout_at_bat?
    assert_equal false, @n11_trout_on_deck_3_tf.trout_at_bat?
    assert_equal false, @n13_trout_on_deck_inning_not_over_tf.trout_at_bat?
    ...
    assert_equal false, @n26_trout_on_deck_bottom_of_inning_tf.trout_at_bat?
    assert_equal false, @n27_trout_on_deck_bottom_of_inning_tf.trout_at_bat?
    assert_equal false, @n28_trout_on_deck_9_tf.trout_at_bat?
  end
...
# ====================================================================
  ...
  test "players_lineup_number ~~ knows someone's lineup number when there have been no changes since game beginning" do
    # assert_equal 2, @n14_home_game_over_ff.players_lineup_number(TROUT_ID)
  end

  test "players_lineup_number ~~ knows someone's lineup number after changes" do
    # assert_equal 6, @n14_home_game_over_ff.players_lineup_number("68298270-9c8e-4139-a8f8-632151fb7077")
    # assert_equal 8, @n14_home_game_over_ff.players_lineup_number("9de4255a-b1d5-455d-bde9-0ae9633e5495")
  end
